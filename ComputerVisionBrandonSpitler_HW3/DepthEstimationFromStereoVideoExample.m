...
frameLeftGray  = rgb2gray(frameLeftRect(1:100,:,:));
frameRightGray = rgb2gray(frameRightRect(1:100,:,:));
...
disparityMap = NCCS(frameLeftGray,frameRightGray,3,100);%selfMadeDisparityFunction(frameLeftGray,frameRightGray,11,30);
